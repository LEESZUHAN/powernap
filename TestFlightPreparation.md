...
- **支援網站設置**
  - [x] 創建獨立的支援文檔倉庫：
     - 倉庫地址：https://github.com/LEESZUHAN/powernap-support
     - 不包含任何源代碼，僅包含用戶支援內容
  - [x] 設置基本支援文檔：
     - README.md：應用概述和功能介紹
     - FAQ.md：常見問題解答
     ...
     - Contact.md：聯絡支援資訊
  - [x] 啟用GitHub Pages：
     - 支援網站URL：https://leeszuhan.github.io/powernap-support/
     - 替換App Store Connect中的支援URL
...
- **內部測試群組**
  - [x] 整理內部團隊成員名單和電子郵件
  - [x] 確認內部測試者都有有效的 Apple ID
  - [x] 準備內部測試者分工和責任

- **外部測試群組**
  - [x] 整理外部測試者名單和電子郵件（最多 10,000 人）
  - [x] 將測試者分組（基於設備類型、測試目的等）
  - [ ] 準備測試邀請訊息範本
...
- [x] 登入 [App Store Connect](https://appstoreconnect.apple.com)
- [x] 建立新應用（「我的應用程式」→「+」→「新應用程式」）
- [x] 填寫應用基本資訊
  - 平台：watchOS
  - 名稱、語言、Bundle ID
  - SKU：內部追蹤代碼
